...
/* ── 加點項目 ──
 *   type    : 'grain'（糧票）| 'meat'（肉票）
 *   name    : 項目名稱（子項留空字串 ''）
 *   sub     : 子項標籤（通常為「初步研究」或「精準突破」）
 *   note    : 備註（選填）
 *   talents : 相關人才名稱陣列（選填，只需設定在有 name 的列）
 * ------------------------------------------------------------ */
const ROWS = [
  ...
  { type: 'grain', name: '風乾技藝', sub: '初步研究', note: '', talents: ['陳醫生','邁克周','周大頭','白鐵匠','強哥','林獸醫'] },
  { type: 'grain', name: '', sub: '精準突破', note: '' },
  ...
  { type: 'grain', name: '醬製技藝', sub: '初步研究', note: '', talents: ['武松','高啟強','非主流','孫糖畫','主持人','書文'] },
  { type: 'grain', name: '', sub: '精準突破', note: '' },
  ...
  { type: 'grain', name: '醃製精研', sub: '初步研究', note: '', talents: ['紫霞仙子','剛毅','菜雕師','小陳哥','張良','林獸醫'] },
  { type: 'grain', name: '', sub: '精準突破', note: '' },
