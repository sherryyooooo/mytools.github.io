...
const TALENTS = [
  /// 珍貴
  // 幸運刮獎兌換
  { name: '剛毅',     defaultQuality: '珍貴', attr: '文' },
  { name: '安賽腰鼓', defaultQuality: '珍貴', attr: '娛' },
  { name: '鄭經理',   defaultQuality: '珍貴', attr: '商' },
  { name: '何律師',   defaultQuality: '珍貴', attr: '農' },
  { name: '登山員',   defaultQuality: '珍貴', attr: '農' },
  { name: '陳醫生',   defaultQuality: '珍貴', attr: '文' },
  // 水滸名將
  { name: '武松',     defaultQuality: '珍貴', attr: '農' },
  { name: '宋江',     defaultQuality: '珍貴', attr: '商' },
  { name: '林沖',     defaultQuality: '珍貴', attr: '文' },
  { name: '魯智深',   defaultQuality: '珍貴', attr: '娛' },
  // 絕代風華
  { name: '白素貞',   defaultQuality: '珍貴', attr: '農' },
  { name: '紅衣教主', defaultQuality: '珍貴', attr: '文' },
  { name: '紫霞仙子', defaultQuality: '珍貴', attr: '娛' },
  { name: '聶小倩',   defaultQuality: '珍貴', attr: '商' },
  // 童年英雄
  { name: '黃飛鴻',   defaultQuality: '珍貴', attr: '娛' },
  { name: '一代大俠', defaultQuality: '珍貴', attr: '農' },
  { name: '多情浪子', defaultQuality: '珍貴', attr: '文' },
  { name: '強哥',     defaultQuality: '珍貴', attr: '商' },
  // 活動氪金獲取
  { name: '阿舟',     defaultQuality: '珍貴', attr: '娛' },
  { name: '張良',     defaultQuality: '珍貴', attr: '商' },
  { name: '牛魔王',   defaultQuality: '珍貴', attr: '娛' },
  { name: '永琪',     defaultQuality: '珍貴', attr: '商' },
  { name: '福爾康',   defaultQuality: '珍貴', attr: '娛' },
  { name: '夏紫薇',   defaultQuality: '珍貴', attr: '文' },
  // VIP
  { name: '林獸醫',   defaultQuality: '珍貴', attr: '娛' },
  { name: '主持人',   defaultQuality: '珍貴', attr: '文' },
  { name: '搖滾明星', defaultQuality: '珍貴', attr: '商' },
  { name: '賽車手',   defaultQuality: '珍貴', attr: '娛' },
  { name: '大小說家', defaultQuality: '珍貴', attr: '文' },
  { name: '國際巨星', defaultQuality: '珍貴', attr: '商' },
  { name: '國民男神', defaultQuality: '珍貴', attr: '農' },
  { name: '金蟬子',   defaultQuality: '珍貴', attr: '農' },
  { name: '姜子牙',   defaultQuality: '珍貴', attr: '商' },
  { name: '贏政',     defaultQuality: '珍貴', attr: '文' },

  /// 卓越
  // 等級獎勵
  { name: '劉二狗',   defaultQuality: '卓越', attr: '娛' },
  { name: '肖衛平',   defaultQuality: '卓越', attr: '文' },
  { name: '周大頭',   defaultQuality: '卓越', attr: '商' },
  { name: '非主流',   defaultQuality: '卓越', attr: '農' },
  { name: '李雙',     defaultQuality: '卓越', attr: '文' },
  { name: '街機高手', defaultQuality: '卓越', attr: '娛' },
  { name: '彪子',     defaultQuality: '卓越', attr: '商' },
  { name: '唐志強',   defaultQuality: '卓越', attr: '農' },
  { name: '小陳哥',   defaultQuality: '卓越', attr: '娛' },
  { name: '火炬手',   defaultQuality: '卓越', attr: '文' },
  { name: '邁克周',   defaultQuality: '卓越', attr: '娛' },
  { name: '菜雕師',   defaultQuality: '卓越', attr: '農' },
  // 幸運刮獎兌換
  { name: '高啟強',   defaultQuality: '卓越', attr: '商' },
  { name: '倪冬梅',   defaultQuality: '卓越', attr: '商' },
  { name: '漁三哥',   defaultQuality: '卓越', attr: '農' },
  // VIP
  { name: '曾守信',   defaultQuality: '卓越', attr: '文' },
  // 風雲錄
  { name: '步驚雲',   defaultQuality: '卓越', attr: '文' },
  { name: '聶風',     defaultQuality: '卓越', attr: '文' },
  // 活動
  { name: '乾隆',     defaultQuality: '卓越', attr: '農' },
  { name: '孫悟空',   defaultQuality: '卓越', attr: '娛' },
  { name: '武則天',   defaultQuality: '卓越', attr: '文' },
  { name: '阿星',     defaultQuality: '卓越', attr: '農' },
  { name: '書文',     defaultQuality: '卓越', attr: '文' },
  { name: '青丘神女', defaultQuality: '卓越', attr: '商' },

  /// 優秀
  // 等級獎勵
  { name: '麗萍',     defaultQuality: '優秀', attr: '農' },
  { name: '張冰棍',   defaultQuality: '優秀', attr: '娛' },
  { name: '趙阿綿',   defaultQuality: '優秀', attr: '商' },
  { name: '孫糖畫',   defaultQuality: '優秀', attr: '文' },
  { name: '張大力',   defaultQuality: '優秀', attr: '娛' },
  { name: '李書蟲',   defaultQuality: '優秀', attr: '文' },
  { name: '白鐵匠',   defaultQuality: '優秀', attr: '農' },
  { name: '電工陳',   defaultQuality: '優秀', attr: '商' },
];
