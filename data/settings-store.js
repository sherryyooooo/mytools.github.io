...
const LS_REGISTRY = [
  ...
  { key: 'ft_row_state',           label: '人才鍛鍊數值輸入',       tool: '農田-人才鍛鍊' },
  { key: 'fa_row_state',           label: '藝人鍛鍊數值輸入',       tool: '農田-藝人鍛鍊' },
  { key: 'fa_topn',                label: '藝人鍛鍊 Top-N 設定',    tool: '農田-藝人鍛鍊' },
  { key: 'fi_row_state',           label: '店鋪研究數值輸入',       tool: '農田-店鋪研究' },

  { key: 'bh_current_cat',         label: '最後選擇的分類',  tool: '澡堂-技師鍛鍊' },
  { key: 'bh_row_state_male',      label: '男澡堂部數值輸入',  tool: '澡堂-技師鍛鍊' },
  { key: 'bh_row_state_female',    label: '女澡堂部數值輸入',  tool: '澡堂-技師鍛鍊' },
  { key: 'bh_row_state_sauna',     label: '桑拿部數值輸入',  tool: '澡堂-技師鍛鍊' },
  { key: 'bh_row_state_massage',   label: '按摩部數值輸入',  tool: '澡堂-技師鍛鍊' },
  { key: 'bh_row_state_tcm',       label: '中醫部數值輸入',  tool: '澡堂-技師鍛鍊' },
  { key: 'bh_row_state_vip',       label: '貴賓部數值輸入',  tool: '澡堂-技師鍛鍊' },
